...
class Admin(User):
    ...
    id = db.Column('id', db.Integer, db.ForeignKey('users.user_id'), primary_key=True)
...
course_instructors = db.Table(
    ...
    db.Column('instructor_id', db.Integer, db.ForeignKey('instructors.id', ondelete='CASCADE'), primary_key=True),
)
